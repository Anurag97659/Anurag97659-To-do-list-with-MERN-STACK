...
useEffect(() => {
    fetch("http://localhost:8000/anuragnidhi-tdl/2005/v1/tdl/todolist-details", {
      method: "GET",
      credentials: "include",
    })
      .then((res) => {
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <label
                ...
                id="data"
                className={`flex-1 text-lg text-gray-800 ${todo.completed ? 'line-through text-gray-600' : ''} transition-all duration-300`}
              >
                {todo.content}
              </label>
            </div>
